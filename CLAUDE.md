...
Indexed: **549 nodes** | **982 edges** | **138 files** | analyzed in 0.2s
...
| Work in `panels` (29 symbols) | `.claude/skills/code-intel/panels/SKILL.md` |
| Work in `storage` (20 symbols) | `.claude/skills/code-intel/storage/SKILL.md` |
| Work in `eval` (16 symbols) | `.claude/skills/code-intel/eval/SKILL.md` |
| Work in `cli` (14 symbols) | `.claude/skills/code-intel/cli/SKILL.md` |
...
| Work in `multi-repo` (8 symbols) | `.claude/skills/code-intel/multi-repo/SKILL.md` |
| Work in `graph` (8 symbols) | `.claude/skills/code-intel/graph/SKILL.md` |
...
| Work in `shared` (7 symbols) | `.claude/skills/code-intel/shared/SKILL.md` |
| Work in `src` (7 symbols) | `.claude/skills/code-intel/src/SKILL.md` |
| Work in `ai` (7 symbols) | `.claude/skills/code-intel/ai/SKILL.md` |
| Work in `flow-detection` (6 symbols) | `.claude/skills/code-intel/flow-detection/SKILL.md` |
| Work in `graph` (6 symbols) | `.claude/skills/code-intel/graph-2/SKILL.md` |
| Work in `shared` (6 symbols) | `.claude/skills/code-intel/shared-2/SKILL.md` |
