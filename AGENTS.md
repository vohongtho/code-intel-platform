...
Indexed: **874 nodes** | **1,788 edges** | **191 files** | analyzed in 0.4s
...
| Work in `auth` (22 symbols) | `.claude/skills/code-intel/auth/SKILL.md` |
...
| Work in `shared` (14 symbols) | `.claude/skills/code-intel/shared/SKILL.md` |
...
| Work in `state` (10 symbols) | `.claude/skills/code-intel/state/SKILL.md` |
| Work in `go-repo` (10 symbols) | `.claude/skills/code-intel/go-repo/SKILL.md` |
| Work in `backup` (8 symbols) | `.claude/skills/code-intel/backup/SKILL.md` |
