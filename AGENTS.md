...
Indexed: **5,068 nodes** | **9,035 edges** | **305 files** | analyzed in 1.0s
...
- Working in **parsing**? → Load `.claude/skills/code-intel/parsing/SKILL.md`
...
| Work in `api` (33 symbols) | `.claude/skills/code-intel/api/SKILL.md` |
