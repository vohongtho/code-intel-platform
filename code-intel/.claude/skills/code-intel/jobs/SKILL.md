---
name: jobs
description: "Covers the **jobs** subsystem of code-intel. 18 symbols across 1 files. Key symbols: `constructor`, `close`. Internal call density: 0.6 calls/symbol."
---

# jobs

> **18 symbols** | **1 files** | path: `core/src/jobs/` | call density: 0.6/sym

## When to Use

Load this skill when:
- The task involves code in `core/src/jobs/`
...
| File | Symbols | Notes |
|------|---------|-------|
| `core/src/jobs/jobs-db.ts` | `Job`, `JobsDB`, `constructor`, `createTables` +(14) | 18 exported |

## Entry Points

Start exploration here — exported symbols with no external callers:

- **`constructor`** `(method)` → `core/src/jobs/jobs-db.ts:41`
- **`close`** `(method)` → `core/src/jobs/jobs-db.ts:195`
