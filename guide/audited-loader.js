...
const pages = window.CODE_INTEL_AUDITED_PAGES || [];
...
function render(slug, push=false) {
  ...
  els.meta.innerHTML = `<span class="meta-pill">${VERSION}</span><span class="meta-pill">source-audited</span><span class="meta-pill">${p.group}</span>`;
