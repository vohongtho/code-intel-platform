...
`code-intel analyze` automatically generates:
- **`AGENTS.md`** + **`CLAUDE.md`** — AI context blocks with stats, CLI reference, and skill links (upserted, never overwrites your content)
...
└── .codeintelignore  # Optional: directories to exclude from analysis
```
