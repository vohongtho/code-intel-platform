---
name: shared
description: "Covers the **shared** subsystem of code-intel-platform. 12 symbols across 5 files. Key symbols: `detectLanguage`, `getSupportedExtensions`. Internal call density: 0.3 calls/symbol."
---

# shared

> **12 symbols** | **5 files** | path: `code-intel/core/src/shared/` | call density: 0.3/sym
...
| File | Symbols | Notes |
|------|---------|-------|
| `code-intel/core/src/shared/logger.ts` | `maskValue`, `maskString`, `deepMask`, `Logger` +(1) | internal |
...
|--------|------|-----:|------:|------|
| `maskString` | function | 2 | 1 | `shared/logger.ts` |
| `maskValue` | function | 2 | 0 | `shared/logger.ts` |
| `deepMask` | function | 0 | 2 | `shared/logger.ts` |
| `env` | function | 0 | 1 | `shared/logger.ts` |
