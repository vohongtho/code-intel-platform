---
name: http
description: "Covers the **http** subsystem of code-intel-platform. 18 symbols across 5 files. Key symbols: `rawReq`, `makeCtx`, `makeTestCtx`. Internal call density: 0.6 calls/symbol."
---

# http

> **18 symbols** | **5 files** | path: `code-intel/core/tests/integration/http/` | call density: 0.6/sym
