---
name: state
description: "Covers the **state** subsystem of code-intel-platform. 10 symbols across 2 files. Key symbols: `AppProvider`. Internal call density: 0 calls/symbol."
---

# state

> **10 symbols** | **2 files** | path: `code-intel/web/src/state/` | call density: 0/sym
...
| File | Symbols | Notes |
|------|---------|-------|
| `code-intel/web/src/state/types.ts` | `CurrentUser`, `SearchResult`, `ChatCitation`, `ChatToolCall` +(3) | 7 exported |
...
- **`AppProvider`** `(function)` → `code-intel/web/src/state/app-context.tsx:118`
