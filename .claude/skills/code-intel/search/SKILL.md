---
name: search
description: "Covers the **search** subsystem of code-intel-platform. 17 symbols across 3 files. Key symbols: `isTestPath`, `isDistPath`, `constructor`. Internal call density: 0.2 calls/symbol."
---

# search

> **17 symbols** | **3 files** | path: `code-intel/core/src/search/` | call density: 0.2/sym
...
| File | Symbols | Notes |
|------|---------|-------|
| `code-intel/core/src/search/vector-index.ts` | `VectorIndex`, `constructor`, `init`, `buildIndex` +(4) | 7 exported |
...
- **`constructor`** `(method)` → `code-intel/core/src/search/vector-index.ts:11`
- **`init`** `(method)` → `code-intel/core/src/search/vector-index.ts:15`
- **`search`** `(method)` → `code-intel/core/src/search/vector-index.ts:59`
